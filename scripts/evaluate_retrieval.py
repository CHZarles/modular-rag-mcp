...
def _run(
    ...
    *,
    ...
    return {
        ...
        "retrieval": {
            "enable_dense": settings.retrieval.get("enable_dense") is True,
            "enable_sparse": settings.retrieval.get("enable_sparse") is True,
            "top_k_dense": settings.retrieval.get("top_k_dense"),
            "top_k_sparse": settings.retrieval.get("top_k_sparse"),
            "top_k_final": settings.retrieval.get("top_k_final"),
            "fusion_algorithm": settings.retrieval.get("fusion_algorithm"),
        },
